...
##### 1) EDA descriptive and viz overall and within each religious affilitation

Given the novel nature of our project, we will conduct thorough exploratory data analysis (EDA) and visualization, with an added focus on religious subgroups (e.g., Jewish religion, Islamic religion). EDA will include univariate statistics and visualization for all variables and bivariate examination of portrait and outcome variables by religious affiliation.

##### 2) Develop clusters of portrait vars

##### 3) Describe who is in each cluster (demos + relig affil)

Following DuBois et al. [@DuBois2019a]

##### 4) Regression models where clusters predict outcomes (5 outcomes, 1 per outcome)

##### 5) Test mediation of clusters by trust in medicine

##### 5) Test moderation of clusters by genetics knowledge, age, and rurality

### EDA

### Developing a religious portrait typology

We will use a k-means clustering algorithm to identify clusters of observations based on religious portrait scores and religious affiliation.

### Describing who is in each cluster

### Modeling outcomes by cluster
